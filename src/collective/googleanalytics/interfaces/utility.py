...
class IAnalyticsTracking(Interface):
    ...
    tracking_excluded_roles = schema.List(
        title=_(u"Excluded Roles"),
...
class IAnalyticsReportsAssignment(Interface):
    ...
    reports_profile = schema.Choice(
        title=_(u"Reports Profile"),
...
class IAnalyticsSettings(Interface):
    ...
    cache_interval = schema.Int(
        title=_(u"Cache interval"),
...
class IAnalytics(
    ...
    report_categories = schema.List(
        title=_(u"Report Categories"),
